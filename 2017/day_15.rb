...
low_16_mask = 0b00000000000000001111111111111111

40000000.times do
  prev_val_a = generate(prev_val_a, gen_a_factor)
  prev_val_b = generate(prev_val_b, gen_b_factor)
  a_low_16 = (prev_val_a & low_16_mask).to_s(2)
  b_low_16 = (prev_val_b & low_16_mask).to_s(2)
  match_count += 1 if a_low_16 == b_low_16
end

puts "Day 15 Solution 1: #{match_count}"
...
5000000.times do
  prev_val_a = generate(prev_val_a, gen_a_factor)
  prev_val_b = generate(prev_val_b, gen_b_factor)
  while prev_val_a % 4 != 0 do
    prev_val_a = generate(prev_val_a, gen_a_factor)
  end
  while prev_val_b % 8 != 0 do
    prev_val_b = generate(prev_val_b, gen_b_factor)
  end
  a_low_16 = (prev_val_a & low_16_mask).to_s(2)
  b_low_16 = (prev_val_b & low_16_mask).to_s(2)
...
puts "Day 15 Solution 2: #{match_count}"
